...
<style>
  ...
  *{box-sizing:border-box}
  ...
  .seg{cursor:pointer}
  .lens{position:fixed;left:0;top:0;width:var(--lens,160px);height:var(--lens,160px);border-radius:50%;background:#D9D9D9;filter:blur(var(--feather,5px));
...
def page(inline):
    return HEAD.replace('__FONTS__', font_faces(inline)) + BODY.replace('__SPINE__', SPINE)
